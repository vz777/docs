...
| effects                  | Une ou plusieurs définitions d'effets séparées par des virgules, qui seront appliquées à l'image dans l'ordre spécifié. Veuillez consulter ci-dessous une description détaillée des effets disponibles <br/> [Expected values](#image-effects-expected-values)                                                                                                                                                                                                                                                                                                                                                                            |        | effects="greyscale,gamma:0.7,vflip"                 |
